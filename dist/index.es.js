...
var MapSelection = function (_PureComponent) {
  ...
  function MapSelection(props) {
    ...
    _this.mapAction = function (rawLng, rawLat) {
      var _proj$transform = transform([rawLng, rawLat], 'EPSG:3857', 'EPSG:4326'),
  ...
  createClass(MapSelection, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        mapExpanded ? '' : React.createElement(MapCover, { title: 'Expand map', onClick: this.handleMap }),
        React.createElement(MapArea, { id: this.id, height: height, expanded: mapExpanded }),
        mapExpanded ? React.createElement(MapClose, { title: 'Collpase map', onClick: this.handleMap }) : ''
      );
    }
  }, {
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'col-xs-12' },
          React.createElement(MapSelection, {
